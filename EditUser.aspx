  ...
  <tr valign="top"> 
    ...
    <td><img src="/portal/images/portal_dottedline.gif" width="17" height="17"></td>
      <td> <font size="3" face="Arial, Helvetica, sans-serif"><span><a href="./"><strong><span style="font-size: 14pt">Home</span></strong></a><span
              style="font-size: 14pt"><strong> :: <a href="UserMgr.aspx">User Manager</a> :: Edit</strong></span></font>
</td>
</tr>
</table>
<br />
  ...
  <tr valign="top"> 
    ...
    <td style="height: 969px"><img src="/portal/images/portal_dottedline.gif" width="17" height="233"></td>
      <td style="height: 969px"> <font size="3" face="Arial, Helvetica, sans-serif">
          ...
          <i>
              <asp:Label ID="lblDescription" runat="server" Text="Edit the user profile information"></asp:Label></i><b><br>
        <br>
        </b></font> 
            ...
            <td><table border="0" cellspacing="1" cellpadding="2" id="tableProfile" runat="server">
                <tr bgcolor="#464646"> 
                  ...
                  <td nowrap style="font-size: 12pt"><font size="1" face="Arial, Helvetica, sans-serif" color="#CC9900"><span style="font-size: 10pt;
                    ...
                    = Required Fields</font><br /><asp:CustomValidator ID="cvMessage" runat="server" ClientValidationFunction="ShowErrorMessage"
                          ...
                          <tr> 
                  <td nowrap align="right" bgcolor="#464646"><font size="1" face="Arial, Helvetica, sans-serif">First Name<strong><span style="font-size: 10pt;
                ...
                <tr>
                    ...
                    <td bgcolor="#464646" nowrap="nowrap">
                        <asp:TextBox ID="tbMI" runat="server" Width="20px"></asp:TextBox></td>
                </tr>
                <tr>
                    <td align="right" bgcolor="#464646" nowrap="nowrap">
                        <font size="1" face="Arial, Helvetica, sans-serif">Last Name<strong><span style="font-size: 10pt;
                          color: #ff0000">*</span></strong><span style="font-size: 7pt">:</span></font></td>
                    <td bgcolor="#464646" nowrap="nowrap">
                        <asp:TextBox ID="tbLastName" runat="server" Width="170px"></asp:TextBox><asp:RequiredFieldValidator
                            ID="rfvLastName" runat="server" ControlToValidate="tbLastName" ErrorMessage='<img src="images/alert.gif">'></asp:RequiredFieldValidator></td>
                </tr>
                <tr>
                    <td align="right" bgcolor="#464646" nowrap="nowrap">
                        <font size="1" face="Arial, Helvetica, sans-serif">Email<strong><span style="font-size: 10pt;
                          color: #ff0000">*</span></strong><span style="font-size: 7pt">:</span></font></td>
                    <td bgcolor="#464646" nowrap="nowrap"><font size="2" face="Arial, Helvetica, sans-serif">
                      <asp:TextBox ID="tbEmail" runat="server" Width="170px"></asp:TextBox><asp:RequiredFieldValidator
                          ID="rfvEmail" runat="server" ControlToValidate="tbEmail" ErrorMessage='<img src="images/alert.gif">'></asp:RequiredFieldValidator><asp:RegularExpressionValidator
                              ID="revEmail" runat="server" ControlToValidate="tbEmail" Display="Dynamic" ErrorMessage="Invalid e-mail"
                              Font-Bold="True" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" Font-Names="Arial"></asp:RegularExpressionValidator></font></td>
                </tr>
                <tr>
                    <td align="right" bgcolor="#464646" nowrap="nowrap">
                ...
                <tr>
                    ...
                    <td bgcolor="#464646" nowrap="nowrap">
                      <asp:TextBox ID="tbContract" runat="server" Width="170px"></asp:TextBox></td>
                </tr>
                <tr> 
                 ...
                 <td nowrap align="right" bgcolor="#464646"><font size="1" face="Arial, Helvetica, sans-serif">Country<strong><span style="font-size: 10pt;
                  ...
                  <font size="2" face="Arial, Helvetica, sans-serif"> 
                      <asp:DropDownList ID="ddlCountry" runat="server" DataSourceID="ObjectDataSource1"
                          DataTextField="CountryName" DataValueField="CountryName" OnDataBound="ddlCountry_DataBound">                      </asp:DropDownList><asp:CustomValidator ID="cvCountry" runat="server" ClientValidationFunction="ValidateCountry"
                      ...
                      <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
                          SelectMethod="GetAllCountries" TypeName="dsCountryTableAdapters.countrylistTableAdapter">                      </asp:ObjectDataSource>
                    </font></td>
                </tr>
                <tr> 
                 <td nowrap align="right" bgcolor="#464646"><font size="1" face="Arial, Helvetica, sans-serif">Phone<strong><span style="font-size: 10pt;
                         color: #ff0000">*</span></strong>:</font></td>
                  <td nowrap bgcolor="#464646"><font size="2" face="Arial, Helvetica, sans-serif"> 
                ...
                <tr> 
                  ...
                  <td nowrap bgcolor="#464646"><font size="2" face="Arial, Helvetica, sans-serif">
                    <asp:TextBox ID="tbFax" runat="server" Width="170px"></asp:TextBox>
                  </font></td>
                </tr>
              ...
              <table border="0" cellspacing="1" cellpadding="2" id="tableUserLevel" runat="server" visible="false">
                    <tr bgcolor="#464646" style="font-weight: bold; font-size: 7pt">
                        ...
                        <td valign="top"><asp:CustomValidator ID="cvUserLevel" runat="server"
                            ...
                            <asp:ListItem Value="A">Level A (All access; No expiration; Monitored by the site admin&lt;br /&gt;&#160;&#160;&#160;&#160;&#160;&#160;with MLB Contacts)</asp:ListItem>
                    ...
                    <tr bgcolor="#464646" style="font-weight: bold; font-size: 7pt">
                        <td valign="top">
                            ...
                            <span style="font-size: 10pt; font-family: Arial">You have successfully <font color="#cc9900">
                                update</font> the user information.<br />
                                <br />
