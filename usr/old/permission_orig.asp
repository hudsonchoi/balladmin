  ...
  <tr>
    ...
    <td> &nbsp;
      <p><font size="5" face="Arial, Helvetica, sans-serif"><b><font size="4"><a href="../default.asp"><font color="#FFFFFF">Administration</font></a>  
        || <a href="./profile.asp"><font color="#FFFFFF">Add A User</font></a></font></b></font><br>
        <br>
      ...
      2 of 2: <i>Give the permission to <%=Session("MemberData").Item("Email")%></i></font> <br>
      ...
      <table border="0" cellspacing="0" cellpadding="4">
        <tr> 
          ...
          <% if Session("UserEntryData").Item("Mlb") then Response.Write("checked") end if%>></td>
        ...
        <tr> 
          ...
          <% if Session("UserEntryData").Item("World") then Response.Write("checked") end if%>></td>
        ...
        <tr> 
          ...
          <% if Session("UserEntryData").Item("Alls") then Response.Write("checked") end if%>></td>
        ...
        <tr> 
          ...
          <% if Session("UserEntryData").Item("Minor") then Response.Write("checked") end if%>></td>
        ...
        <tr> 
          ...
          <% if Session("UserEntryData").Item("Coop") then Response.Write("checked") end if%>></td>
