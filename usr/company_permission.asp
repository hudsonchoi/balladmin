...
if Request.Form("Referer") = "add_company" then 'When it's from add_company.asp via Post
	...
	If myErr > 0 Then
		...
		"&24=" & Server.URLEncode(Request.Form("Alls2007"))
    ...
    <td><img src="../../portal/images/portal_dottedline.gif" width="17" height="233"></td>
      <td> <font size="3" face="Arial, Helvetica, sans-serif">Step 2 of 2: <i>Set 
        ...
        <table border="0" cellspacing="0" cellpadding="4">
          ...
          <% if myMlb2003 then Response.Write("checked") end if%>>            </td>
          </tr>
          <tr>
          ...
          <% if mySpring then Response.Write("checked") end if%>>            </td>
          </tr>
          <tr>
          ...
          <% if myAlls then Response.Write("checked") end if%>>            </td>
          </tr>
          <tr>
          ...
          <% if myWorld then Response.Write("checked") end if%>>            </td>
          </tr>
          <tr> 
          ...
          <% if myCoop then Response.Write("checked") end if%>>            </td>
          </tr>
          <tr>
          ...
          <% if myMascot then Response.Write("checked") end if%>>            </td>
          </tr>
          <tr> 
          ...
          <% if myMinor then Response.Write("checked") end if%>>            </td>
          </tr>
            <tr> 
          ...
          <% if myTrend then Response.Write("checked") end if%>>            </td>
          </tr>
          <tr>
