...
Dim em, un
Dim myUserName, myPassword, myCompany, myEmail, myContract, myMlb, myMinor, myAlls, myCoop, myWorld, myMascot, mySpring, myTrend, mySuper, myMlb2003
...
<TABLE BORDER=0 CELLSPACING=1 CELLPADDING=2 width="620">
  <TR bgcolor="#003366">
    ...
    <TD><font color="#CCCCCC" size="2" face="Arial, Helvetica, sans-serif">Post Season </font></TD>
