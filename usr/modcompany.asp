...
<form method="post" action="/admin/usr/m_company.asp" name="moduser1">
...
<table border="0" cellspacing="0" cellpadding="0">
  <tr valign="top"> 
    ...
    <td><img src="/portal/images/portal_dottedline.gif" width="17" height="233"></td>
      ...
      <td> <font size="3" face="Arial, Helvetica, sans-serif">Step 1 of 3: <i>Enter 
        The Company User Name</i></font><br>
        <br>
    
        <table border="0" cellspacing="0" cellpadding="1">
          <tr> 
            <td nowrap align="right">&nbsp;</td>
            <td nowrap><font size="1" face="Arial, Helvetica, sans-serif">User Name:</font></td>
          </tr>
          <%
		If Request.QueryString("un")="0" then
		    Response.Write("<tr><td>&nbsp;</td>")
            Response.Write("<td><b><font size='2' face='Arial, Helvetica, sans-serif' color=red>")
			Response.Write("Invalid user name!</font></b><br>")
		...
		%>
          ...
          <tr> 
            ...
            <td nowrap> <font face="Arial, Helvetica, sans-serif" size="2"> 
			  <input type="hidden" name="referer" value="modcompany">
