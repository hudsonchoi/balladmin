...
Dim myMlb, myMinor, myAlls, myCoop, myWorld, myMascot, mySpring, myTrend, mySuper, myMlb2003, myAlls2007
...
if not isEmpty (Request.Form("goback")) then 'Go back
	...
	"&24=" & Server.URLEncode(myAlls2007)
...
'Mailer.RemoteHost = "192.168.1.101"
Mailer.RemoteHost = "localhost"
Mailer.ContentType = "text/html" 
