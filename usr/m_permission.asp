...
Dim myContract, myFirstName, myMi, myLastName, myPassword, myMlb, myMinor, myAlls, myCoop, myWorld, myMascot, mySpring, myProvince, myTrend, mySuper, myMlb2003, myCreative, myAlls2007
...
if Request.Form("Referer") = "m_profile" then
	...
	If myErr > 0 Then
		...
		"&25=" & Server.URLEncode(Request.Form("Super")) & _
		"&26=" & Server.URLEncode(Request.Form("Mlb2003")) & _
		"&27=" & Server.URLEncode(Request.Form("Creative")) & _
		"&28=" & Server.URLEncode(Request.Form("Alls2007"))
...
elseif Len (Request.QueryString("err")) > 0 Then
	...
	myCreative = Request.QueryString("27")
	myAlls2007 = Request.QueryString("28")
else
    ...
    <td><img src="../../portal/images/portal_dottedline.gif" width="17" height="233"></td>
      <td><font size="3" face="Arial, Helvetica, sans-serif"> <font size="3" face="Arial, Helvetica, sans-serif">Step 
        ...
        <table border="0" cellspacing="0" cellpadding="4">
          <tr> 
            <td nowrap align="right"><table cellpadding="0" cellspacing="0">
              <tr>
                <td><img src="../../portal/images/2006OpeningDay_OFF.gif"></td>
                <td>&nbsp;</td>
                <td><img name="A2003" border="0" src="../../portal/images/2006ClubMarks_OFF.gif" width="192" height="21"></td>
              </tr>
            </table></td>
            <td nowrap valign="bottom"> 
              <input type="checkbox" id="checkbox1" name="section" value="Mlb2003"
          <% if myMlb2003 then Response.Write("checked") end if%>>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            <td nowrap align="right"><img src="../../portal/images/2006PostSeason_OFF.gif" width="192" height="21"></td>
            <td nowrap valign="bottom">
          ...
          <tr> 
            ...
            <td nowrap valign="bottom"> 
              <input type="checkbox" id=checkbox1 name="section" value="Creative"
          <% if myCreative then Response.Write("checked") end if%>>
            </td>
          </tr>
		   <tr>
