...
if Request.Form("Referer") = "moduser" then 'When it's from moduser.asp via Post
	...
	Dim em, un
	Dim myPassword, myFirstName, myMi, myLastName, myCompany, myContract, myAddress1, myAddress2, myCity, myState, myZip, myPhone, myFax, myCountry, myEmail, myMlb, myMinor, myAlls, myCoop, myWorld, myMascot, mySpring, myProvince, myTrend, mySuper, myMlb2003, myCreative, myAlls2007
	...
	If Len(Request.Form("Email")) > 0 Then
		...
		"licensee.Phone, licensee.Fax, licensee.Country, licensee.Email, licensee.Mlb, licensee.Minor, licensee.Alls, licensee.Coop, licensee.World, licensee.Mascot, licensee.Spring, licensee.Trend, licensee.Super, licensee.Mlb2003, licensee.Creative, licensee.Alls2007 " & _
               ...
               <td nowrap align="right" bgcolor="#464646"><font size="1" face="Arial, Helvetica, sans-serif">Address 2:</font></td>
                ...
                <tr bgcolor="#404040"> 
                  ...
                  <td nowrap bgcolor="#464646"> 
					...
					<input type="hidden" name="Creative" size="25" value="<%=myCreative%>">
