...
Dim myContract, myFirstName, myMi, myLastName, myPassword, myMlb, myMinor, myAlls, myCoop, myWorld, myMascot, mySpring, myProvince, myTrend
...
if Request.Form("Referer") = "m_profile" then
	...
	If myErr > 0 Then
		...
		"&24=" & Server.URLEncode(Request.Form("Trend"))
