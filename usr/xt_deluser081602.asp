...
Dim em, un
Dim myPassword, myFirstName, myMi, myLastName, myCompany, myContract, myAddress1, myAddress2, myCity, myState, myZip, myPhone, myFax, myCountry, myEmail, myMlb, myMinor, myAlls, myCoop, myWorld, myMascot, mySpring, myTrend
