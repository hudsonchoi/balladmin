...
Dim em, un
Dim myUserName, myPassword, myCompany, myID, myEmail, myContract, myMlb, myMinor, myAlls, myCoop, myWorld, myMascot, mySpring, myTrend, mySuper, myMlb2003, myCreative, myAlls2007
...
If oRs.RecordCount > 0 Then
	...
	Session("CompanyDelData").Item("Super")=mySuper
	Session("CompanyDelData").Item("Mlb2003")=myMlb2003
	Session("CompanyDelData").Item("Creative")=myCreative
	Session("CompanyDelData").Item("Alls2007")=myAlls2007
