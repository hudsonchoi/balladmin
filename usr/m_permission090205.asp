...
Dim myContract, myFirstName, myMi, myLastName, myPassword, myMlb, myMinor, myAlls, myCoop, myWorld, myMascot, mySpring, myProvince, myTrend, mySuper, myMlb2003
...
if Request.Form("Referer") = "m_profile" then
	...
	If myErr > 0 Then
		...
		"&26=" & Server.URLEncode(Request.Form("Mlb2003"))
    ...
    <td><img src="../../portal/images/portal_dottedline.gif" width="17" height="233"></td>
      <td><font size="3" face="Arial, Helvetica, sans-serif"> <font size="3" face="Arial, Helvetica, sans-serif">Step 
        ...
        <table border="0" cellspacing="0" cellpadding="4">
          <tr> 
            <td nowrap align="right"><img name="A2002" border="0" src="../../portal/images/portal_nav_style2002_1.gif" width="192" height="22"></td>
          ...
          <tr> 
            <td nowrap align="right"><img name="A2003" border="0" src="../../portal/images/portal_nav_style2003_1.gif" width="192" height="22"></td>
            <td nowrap valign="bottom"> 
