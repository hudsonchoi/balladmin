            ...
            <td>
              <table border="0" cellspacing="1" cellpadding="2">
                ...
                if CompanyDelData.Item("Mlb") then
					Response.Write("2002 MLB Style Guide<br>")
				end if
				if CompanyDelData.Item("Mlb2003") then
					Response.Write("2003 MLB Style Guide<br>")
				end if
				...
				if CompanyDelData.Item("Trend") then
					Response.Write("Spring and Summer Trend<br>")
				end if
				if CompanyDelData.Item("Super") then
					Response.Write("Super Human<br>")
				end if
				if CompanyDelData.Item("Creative") then
					Response.Write("Design Services<br>")
				end if
				if CompanyDelData.Item("Alls2007") then
					Response.Write("2007 All-Star Game Preview<br>")
				end if
