        ...
        <table border="0" cellspacing="0" cellpadding="4">
          <tr> 
            ...
            <td nowrap valign="bottom"> 
              <input type="checkbox" id="checkbox1" name="section" value="Mlb" <% if myMlb then Response.Write("checked") end if%>>
            </td>
          </tr>
          <tr> 
          ...
          <tr> 
            ...
            <td nowrap valign="bottom"> 
              <input type="checkbox" id=checkbox1 name="section" value="Super" <% if mySuper then Response.Write("checked") end if%>>
            </td>
          </tr>
          <tr> 
