...
Dim myContract, myUserName,	myPassword,	myMlb, myMinor,	myAlls,	myCoop,	myWorld, myMascot, mySpring, myTrend, mySuper, myMlb2003, myCreative, myAlls2007
...
if Request.Form("Referer") = "m_company" then
	...
	If myErr > 0 Then
		...
		"&23=" & Server.URLEncode(Request.Form("Mlb2003")) & _
		"&24=" & Server.URLEncode(Request.Form("Creative")) & _
		"&25=" & Server.URLEncode(Request.Form("Alls2007"))
	...
	myCreative = Request.Form("Creative")
	myAlls2007 = Request.Form("Alls2007")
...
elseif Len (Request.QueryString("err")) > 0 Then
	...
	myCreative = Request.QueryString("24")
	myAlls2007 = Request.QueryString("25")
else
    ...
    <td><img src="../../portal/images/portal_dottedline.gif" width="17" height="233"></td>
      <td><font size="3" face="Arial, Helvetica, sans-serif"> <font size="3" face="Arial, Helvetica, sans-serif">Step 
        ...
        <table border="0" cellspacing="0" cellpadding="4">
          <tr> 
            <td nowrap align="right"><table cellpadding="0" cellspacing="0"><tr><td><img src="../../portal/images/2006OpeningDay_OFF.gif"></td><td>&nbsp;</td><td><img name="A2003" border="0" src="../../portal/images/2006ClubMarks_OFF.gif" width="192" height="21"></td></tr></table></td>
            <td nowrap valign="bottom"> 
              <input type="checkbox" id="checkbox1" name="section" value="Mlb2003" <% if myMlb2003 then Response.Write("checked") end if%>>            </td>
          </tr>
          <tr>
            <td nowrap align="right"><img name="E" border="0" src="../../portal/images/portal_nav_spring_1.gif" width="192" height="22"></td>
            <td nowrap valign="bottom">
              <input type="checkbox" id=checkbox1 name="section" value="Spring" <% if mySpring then Response.Write("checked") end if%>>            </td>
          </tr>
          <tr>
            <td nowrap align="right"><img name="D" border="0" src="../../portal/images/portal_nav_as_1.gif" width="192" height="22"></td>
            <td nowrap valign="bottom">
              <input type="checkbox" id=checkbox1 name="section" value="Alls" <% if myAlls then Response.Write("checked") end if%>>            </td>
          </tr>
          <tr>
            <td nowrap align="right"><img name="C" border="0" src="../../portal/images/2006PostSeason_OFF.gif" width="192" height="21"></td>
            <td nowrap valign="bottom">
              <input type="checkbox" id=checkbox1 name="section" value="World" <% if myWorld then Response.Write("checked") end if%>>            </td>
          </tr>
          <tr> 
            <td nowrap align="right"><img name="B" border="0" src="../../portal/images/portal_nav_coop_1.gif" width="192" height="22"></td>
            <td nowrap valign="bottom">
			<input type="checkbox" id=checkbox1 name="section" value="Coop" <% if myCoop then Response.Write("checked") end if%>>            </td>
          </tr>
          <tr>
            <td nowrap align="right"><img src="../../portal/images/2006Mascot_OFF.gif" width="192" height="21"></td>
            <td nowrap valign="bottom">
              <input type="checkbox" id=checkbox1 name="section" value="Mascot" <% if myMascot then Response.Write("checked") end if%>>            </td>
          </tr>
          <tr> 
            <td nowrap align="right"><img name="E" border="0" src="../../portal/images/portal_nav_minor_1.gif" width="192" height="22"></td>
            <td nowrap valign="bottom"> 
              <input type="checkbox" id=checkbox1 name="section" value="Minor" <% if myMinor then Response.Write("checked") end if%>>            </td>
          </tr>
          <tr>
            <td nowrap align="right"><img name="E" border="0" src="../../portal/images/portal_nav_trend_1.gif" width="192" height="22"></td>
            <td nowrap valign="bottom">
              <input type="checkbox" id=checkbox1 name="section" value="Trend" <% if myTrend then Response.Write("checked") end if%>>            </td>
          </tr>
          <tr> 
            <td align="right" nowrap class="style1"><img name="E" border="0" src="/portal/images/2006CreativeServ_OFF.gif" width="192" height="22"></td>
            <td nowrap valign="bottom"> 
              <input type="checkbox" id=checkbox1 name="section" value="Creative" <% if myCreative then Response.Write("checked") end if%>>            </td>
          </tr>
          <tr>
            <td align="right" nowrap class="style1"><img src="../../portal/images/2007AllStar_OFF.gif" width="192" height="21"></td>
            <td nowrap valign="bottom"><input type="checkbox" id=checkbox1 name="section" value="Alls2007" <% if myAlls2007 then Response.Write("checked") end if%>></td>
          </tr>
          <tr>  
            <td colspan="2" align="right">
				<input type="checkbox" id=checkbox1 name="modify" value="True" checked><font size="2" face="Arial, Helvetica, sans-serif">
				Modify all users belong to this company</font>            </td>
          </tr> 
          <tr> 
            <td colspan="2" align="right"> 
