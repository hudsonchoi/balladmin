...
<table border="0" cellspacing="0" cellpadding="0">
  <tr valign="top"> 
    ...
    <td><img src="/portal/images/portal_dottedline.gif" width="17" height="233"></td>
      <td>
        <FORM action="list_users_result.asp" method=POST id=form1 name=form1>
			
			<font face="Arial, Helvetica, sans-serif" size="2" color="#CCCCCC">
			List the users in the order of:<br>
			<input type="radio" name="order" value="Email" checked>Email<br>
			<input type="radio" name="order" value="FirstName">First Name<br>
			<input type="radio" name="order" value="LastName">Last Name<br>
			<input type="radio" name="order" value="Company">Company<br>
			<br>
			<INPUT type="submit" value="Format for printout" id=submit1 name="type"><br><br>
			<INPUT type="submit" value="Output to Excel" id=submit2 name="type"><br><br>
