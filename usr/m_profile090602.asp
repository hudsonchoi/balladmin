...
if Request.Form("Referer") = "moduser" then 'When it's from moduser.asp via Post
	...
	Dim em, un
	Dim myPassword, myFirstName, myMi, myLastName, myCompany, myContract, myAddress1, myAddress2, myCity, myState, myZip, myPhone, myFax, myCountry, myEmail, myMlb, myMinor, myAlls, myCoop, myWorld, myMascot, mySpring, myProvince, myTrend, mySuper
	...
	If Len(Request.Form("Email")) > 0 Then
		...
		"licensee.Phone, licensee.Fax, licensee.Country, licensee.Email, licensee.Mlb, licensee.Minor, licensee.Alls, licensee.Coop, licensee.World, licensee.Mascot, licensee.Spring, licensee.Trend, licensee.Super " & _
