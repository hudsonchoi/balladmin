...
'strSQL = "SELECT licensee.Password, licensee.FirstName, licensee.LastName, legacyusers.Company, " & _
	'	"licensee.Phone, licensee.Email, licensee.Mlb, licensee.Minor, licensee.Alls, licensee.Coop, licensee.World, licensee.Mascot, licensee.Spring, licensee.Trend, licensee.Super, licensee.Mlb2003 " & _
...
Select Case Request.Form("order")
	   Case "Email"  oRs.Open "Exec sp_licenseeEmail", oConn
	   Case "FirstName"  oRs.Open "Exec sp_licenseeFirstName", oConn
	   Case "LastName"   oRs.Open "Exec sp_licenseeLastName", oConn
	   Case "Company"      oRs.Open "Exec sp_licenseeCompany", oConn
End Select

'strSQL = "sp_licenseeEmail"
...
'oRs.Open "Exec sp_licenseeEmail", oConn
...
<TABLE BORDER=0 CELLSPACING=1 CELLPADDING=2 width="620">
  <TR bgcolor="#003366"> 
    ...
    <TD><font face="Arial, Helvetica, sans-serif" size="2" color="#CCCCCC">2006 Club Marks </font></TD>
    <TD><font face="Arial, Helvetica, sans-serif" size="2" color="#CCCCCC">Coop</font></TD>
    <TD><font face="Arial, Helvetica, sans-serif" size="2" color="#CCCCCC">Post Season </font></TD>
    ...
    <TD><font face="Arial, Helvetica, sans-serif" size="2" color="#CCCCCC">Opening Day </font></TD>
    <TD><font face="Arial, Helvetica, sans-serif" size="2" color="#CCCCCC">Theme Art </font></TD>
  </TR>
<%
i=0
Do While not oRs.EOF%>
    ...
    <TD bgcolor="<% if i mod 2 = 0 then Response.Write("#e8e8e8") else Response.Write("#cccccc") end if %>" align="center"><font face="Arial, Helvetica, sans-serif" size="2"><% if oRs("Mlb2003") then Response.Write("o") else Response.Write("x") end if %></font></td>
...
<TABLE BORDER=0 CELLSPACING=1 CELLPADDING=2 width="620">
  <TR bgcolor="#003366"> 
    ...
    <TD><font face="Arial, Helvetica, sans-serif" size="2" color="#CCCCCC">2006 Club Marks</font></TD>
    <TD><font face="Arial, Helvetica, sans-serif" size="2" color="#CCCCCC">Coop</font></TD>
    <TD><font face="Arial, Helvetica, sans-serif" size="2" color="#CCCCCC">Post</font></TD>
    <TD><font face="Arial, Helvetica, sans-serif" size="2" color="#CCCCCC">ASG</font></TD>
    <TD><font face="Arial, Helvetica, sans-serif" size="2" color="#CCCCCC">Minor</font></TD>
    <TD><font face="Arial, Helvetica, sans-serif" size="2" color="#CCCCCC">Mascot</font></TD>
    <TD><font face="Arial, Helvetica, sans-serif" size="2" color="#CCCCCC">Spring</font></TD>
    <TD><font face="Arial, Helvetica, sans-serif" size="2" color="#CCCCCC">Opening</font></TD>
    <TD><font face="Arial, Helvetica, sans-serif" size="2" color="#CCCCCC">Theme Art </font></TD>
  </TR>
<%
i=0
