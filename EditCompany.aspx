<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditCompany.aspx.cs" Inherits="EditCompany" %>
...
{
    if (document.forms[0].rblUserLevel[4].checked){
        document.getElementById("lblStep").innerText = "Step 2 of 2";
    }else{
        document.getElementById("lblStep").innerText = "Step 2 of 5";
    }
...
function ShowHideModifyAll2()
{
    if (document.forms[0].rblUserCategory[4].checked){
       document.getElementById("modifyAll2Layer").style.visibility="hidden";
    }else{
        document.getElementById("modifyAll2Layer").style.visibility="visible";
    }
}
  ...
  <tr valign="top"> 
    ...
    <td><img src="/portal/images/portal_dottedline.gif" width="17" height="17"></td>
      <td> <font size="3" face="Arial, Helvetica, sans-serif"><span><a href="./"><strong><span style="font-size: 14pt">Home</span></strong></a><span
              style="font-size: 14pt"><strong> :: <a href="CompanyMgr.aspx?prefix=A">Company Manager</a> :: Edit</strong></span></font>
</td>
</tr>
</table>
<br />
  ...
  <tr valign="top"> 
    ...
    <td style="height: 969px"><img src="/portal/images/portal_dottedline.gif" width="17" height="233"></td>
      <td style="height: 969px"> <font size="3" face="Arial, Helvetica, sans-serif">
          ...
          <i>
              <asp:Label ID="lblDescription" runat="server" Text="Edit the company information"></asp:Label></i><b><br>
        <br>
        </b></font> 
        ...
        <table border="0" cellspacing="0" cellpadding="0" bgcolor="#333333">
          <tr>
            <td><table border="0" cellspacing="1" cellpadding="2" id="tableProfile" runat="server">
                <tr bgcolor="#464646"> 
                  ...
                  <td nowrap bgcolor="#464646"><font size="2" face="Arial, Helvetica, sans-serif"> 
                      <asp:TextBox ID="tbCompany" runat="server" Width="170px"></asp:TextBox><asp:RequiredFieldValidator
                          ID="rfvCompany" runat="server" ControlToValidate="tbCompany" ErrorMessage='<img src="images/alert.gif">'></asp:RequiredFieldValidator></font></td>
                </tr>
                <tr> 
                 ...
                 <td nowrap align="right" bgcolor="#464646"><font size="1" face="Arial, Helvetica, sans-serif">Country<strong><span style="font-size: 10pt;
                  ...
                  <font size="2" face="Arial, Helvetica, sans-serif"> 
                      <asp:DropDownList ID="ddlCountry" runat="server" DataSourceID="ObjectDataSource1"
                          DataTextField="CountryName" DataValueField="CountryName" OnDataBound="ddlCountry_DataBound">
                ...
                <tr> 
                  <td nowrap align="right" bgcolor="#464646"><font size="1" face="Arial, Helvetica, sans-serif">User Name<strong><span style="font-size: 10pt;
                          color: #ff0000">*</span></strong></font></td>
                  <td nowrap bgcolor="#464646"><font size="2" face="Arial, Helvetica, sans-serif"> 
                      <asp:TextBox ID="tbUserName" runat="server" Width="170px"></asp:TextBox><asp:RequiredFieldValidator
                          ID="rfvUserName" runat="server" ControlToValidate="tbUserName" ErrorMessage='<img src="images/alert.gif">' Display="Dynamic"></asp:RequiredFieldValidator></font></td>
                </tr>
                <tr> 
                  <td nowrap align="right" bgcolor="#464646"><font size="1" face="Arial, Helvetica, sans-serif">Password<strong><span style="font-size: 10pt;
                          color: #ff0000">*</span></strong></font></td>
                  <td nowrap bgcolor="#464646"><font size="2" face="Arial, Helvetica, sans-serif"> 
                      <asp:TextBox ID="tbPassword" runat="server" Width="170px"></asp:TextBox><asp:RequiredFieldValidator
                          ID="rfvPassword" runat="server" ControlToValidate="tbPassword" ErrorMessage='<img src="images/alert.gif">'></asp:RequiredFieldValidator></font></td>
                </tr>
                <tr align="right"> 
                  <td bgcolor="#464646">&nbsp;</td>
                  <td nowrap bgcolor="#464646" align="left">
                      <asp:Literal ID="ltrBack" runat="server"><input type="button" name="btnBack" value="<<< Go Back" onclick="history.go(-1)" /></asp:Literal>
              ...
              <table border="0" cellspacing="1" cellpadding="2" id="tableUserLevel" runat="server" visible="false">
                    <tr bgcolor="#464646" style="font-weight: bold; font-size: 7pt">
                        ...
                        <td valign="top"><asp:CustomValidator ID="cvUserLevel" runat="server"
                            ...
                            <asp:ListItem Value="X">No Access at this time <font color="red">New!</font></asp:ListItem>    
                                </asp:RadioButtonList>
                ...
                <table border="0" cellspacing="1" cellpadding="2" id="tableUserCategory" runat="server" visible="false">
                    <tr bgcolor="#464646" style="font-weight: bold; font-size: 7pt">
                        ...
                        <td valign="top"><asp:CustomValidator ID="cvUserCategory" runat="server" ClientValidationFunction="ValidateUserCategory"
                            ...
                            <div id="modifyAll2Layer" runat="server">
                            <asp:RadioButtonList ID="rblModifyAll2" runat="server" Font-Names="Arial" Font-Size="10pt"
                                ForeColor="Yellow" Width="270px" Visible="False">
                                <asp:ListItem Selected="True" Value="1">This security setting will be applied to the new registrants from this company who will register FROM NOW ON.</asp:ListItem>
                                <asp:ListItem Value="2">This security setting will be applied to not only the new registrants from this company but also ALL EXISTING registrants.</asp:ListItem>
                            </asp:RadioButtonList>
                            </div>
                        </td>
                    </tr>
                ...
                <table border="0" cellspacing="1" cellpadding="2" id="tableRequestor" runat="server" visible="false">
                    <tr bgcolor="#464646" style="font-weight: bold; font-size: 7pt">
                        ...
                        <td valign="top"><asp:CustomValidator ID="cvRequestor" runat="server" ClientValidationFunction="ValidateRequestor"
                            ...
                            </asp:ObjectDataSource><asp:RadioButtonList ID="rblModifyAll3" runat="server" Font-Names="Arial" Font-Size="10pt"
                                ForeColor="Yellow" Width="270px" Visible="False">
                                <asp:ListItem Selected="True" Value="1">This security setting will be applied to the new registrants from this company who will register FROM NOW ON.</asp:ListItem>
                                <asp:ListItem Value="2">This security setting will be applied to not only the new registrants from this company but also ALL EXISTING registrants.</asp:ListItem>
                    ...
                    <tr bgcolor="#464646" style="font-weight: bold; font-size: 7pt">
                        ...
                        <td valign="top"><asp:CustomValidator ID="cvSitelet" runat="server" ClientValidationFunction="ValidateUserCategory"
                           ...
                           <asp:CheckBoxList ID="cblSitelet" runat="server" Font-Names="Arial" Font-Size="12px" DataSourceID="ObjectDataSource3" DataTextField="description" DataValueField="id" OnDataBound="cblSitelet_DataBound">
                            ...
                            <br />
                            &nbsp;<br />
                            <asp:RadioButtonList ID="rblModifyAll" runat="server" Font-Names="Arial" Font-Size="10pt"
                                ForeColor="Yellow" Width="270px" Visible="false">
                                <asp:ListItem Selected="True" Value="1">This security setting will be applied to the new registrants from this company who will register FROM NOW ON.</asp:ListItem>
                                <asp:ListItem Value="2">This security setting will be applied to not only the new registrants from this company but also ALL EXISTING registrants.</asp:ListItem>
                            </asp:RadioButtonList></td>
                    ...
                    <tr bgcolor="#464646" style="font-weight: bold; font-size: 7pt">
                        <td valign="top">
                            ...
                            <span style="font-size: 10pt; font-family: Arial">You have successfully <font color="#cc9900">
                                update</font> the company information.<br />
                                <br />
