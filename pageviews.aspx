<%@ Page Language="C#" AutoEventWireup="true" CodeFile="pageviews.aspx.cs" Inherits="pageviews" %>
...
<table border="0" cellspacing="0" cellpadding="0" runat="server" id="siteletTable" width="747">
  ...
  <td align="right">
    ...
    <asp:GridView ID="gvPageViews" runat="server" CellSpacing="2" Font-Names="Arial" GridLines="None">
        <Columns>
        </Columns>
