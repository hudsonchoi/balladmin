...
<form name="form1" method="post" action="xt_login.asp">
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="3" bgcolor="#464646">
                ...
                <tr> 
                  <td align="center" colspan="2">
                    <b><font size="2" color="red" face="Arial, Helvetica, sans-serif">Invalid 
                    Username and Password.. </font></b></td>
                </tr>
                <%end if %>
                <tr> 
                ...
                <tr> 
                  <td align="center">&nbsp;</td>
                  <td><font size="2" face="Arial, Helvetica, sans-serif"> 
                    <input type="submit" name="Submit" value="Login"></font></td>
                </tr>
              </table>
            </td>
          </tr>
